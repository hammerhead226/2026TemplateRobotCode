...
public class ObjectDetection extends SubsystemBase {
    ...
    public Translation2d getNotePositionRobotRelative() {
        ...
        Translation2d camRelNoteLocT2dCorrected = new Translation2d(
                Units.inchesToMeters(radiusInchCorrected), Rotation2d.fromDegrees(noteYawAngleDegCorrected));
        ...
        Translation2d roboRelNoteLocT2dCorrected = camRelNoteLocT2dCorrected
                .rotateBy(Rotation2d.fromDegrees(0))
                .plus(new Translation2d(Units.inchesToMeters(12), 0));
    ...
    public static Pose2d calculateNotePositionFieldRelative(
        ...
        Translation2d fieldRelNoteLocT2dCorrected = objectRobotRelativePoseMeters
        ...
        Logger.recordOutput(
                ...
                Units.metersToInches(fieldRelNoteLocT2dCorrected.getDistance(pickedRobotPoseMeters.getTranslation())));

        // Translation3d fieldRelNoteLocT3d = new Translation3d(fieldRelNoteLocT2dCorrected.getX(),
        // fieldRelNoteLocT2dCorrected.getY(), 10);
        Pose3d fieldRelNoteLocP3d = new Pose3d(new Pose2d(fieldRelNoteLocT2dCorrected, new Rotation2d()));
