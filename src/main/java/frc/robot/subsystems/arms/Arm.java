...
public class Arm extends SubsystemBase {
    ...
    private static LoggedTunableNumber maxVelocityDegPerSec =
            new LoggedTunableNumber(armName + "/maxVelocityDegPerSec", ArmConstants.MAX_VELOCITY_DEG_PER_SEC);
    ...
    public Arm(ArmIO arm) {
        ...
        armConstraints =
                new TrapezoidProfile.Constraints(maxVelocityDegPerSec.get(), maxAccelerationDegPerSecSquared.get());
    ...
    public boolean atPositionDegs(double positionDegs, double threshold) {
        return (Math.abs(armInputs.positionDegs - positionDegs) <= threshold);
    }
