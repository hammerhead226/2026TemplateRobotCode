...
public class TrigLocalizationUtil {
    public static Transform2d robotToTarget(
            double txRadians, double tyRadians, Transform3d robotToCamera, double targetY) {
    ...
    public static Transform2d robotToTarget(
            double txRadians, double tyRadians, Vision vision, int cameraIndex, double targetY) {
