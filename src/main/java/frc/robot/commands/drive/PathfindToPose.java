...
public class PathfindToPose extends Command {
    ...
    // TODO would these additional arguments be passed in at the RobotContainer level? Make sure we apply the same math
    // and constraints as we apply in JoystickController
