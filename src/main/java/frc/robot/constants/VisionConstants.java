...
public class VisionConstants {
    ...
    public static String camera1Name = "rear_camera";
    public static String cameraObjectDetect = "Front PhotonVision Camera";
    ...
    public static Transform3d robotToCameraObjectDetect = new Transform3d(0.2, 0.0, 0.2, new Rotation3d(0.0, 0.0, 0.0));
